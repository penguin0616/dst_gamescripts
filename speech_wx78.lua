...
--fallback to speech_wilson.lua     ANNOUNCE_BOOK_MOON_DAYTIME = "only_used_by_waxwell_and_wicker",
    ...
    -- rifts 4
    ANNOUNCE_EXIT_GELBLOB = "NEARLY TERMINATED BUT GEARS FEEL LUBRICATED",
	ANNOUNCE_SHADOWTHRALL_STEALTH = "MUST DISENGAGE ITS STEALH MECHANISM AND KILL IT", -- TODO
...
--fallback to speech_wilson.lua 			DEPLETED = "only_used_by_wanda",
        ...
        RABBITHAT = "TODO",
        WORM_BOSS = "WHO RESTORED THIS VERSION?!",
    },
