...
local function OnThrown(inst, owner, target, attacker)
	...
	if inst.bounces == nil then
		inst.bounces = owner ~= nil and owner.components.setbonus ~= nil and owner.components.setbonus:IsEnabled() and TUNING.STAFF_LUNARPLANT_SETBONUS_BOUNCES or TUNING.STAFF_LUNARPLANT_BOUNCES
