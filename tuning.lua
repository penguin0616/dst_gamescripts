...
--[[
        ...
        -- Wolfgang
        MIGHTINESS_MAX = 100,
        MIGHTINESS_DRAIN_RATE = (100*(1/3))/total_day_time,	-- base loss of 1/3 of MIGHTINESS_MAX per day

        MIGHTINESS_DRAIN_MULT_SLOW = 0.75,
        MIGHTINESS_DRAIN_MULT_NORMAL = 1,
        MIGHTINESS_DRAIN_MULT_FAST = 4,
        MIGHTINESS_DRAIN_MULT_FASTEST = 12,
        MIGHTINESS_DRAIN_MULT_STARVING = 24,
		...
		WOLFGANG_MIGHTINESS_DRAIN_DELAY = 2,
