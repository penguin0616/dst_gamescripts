...
function Tune(overrides)
    ...
    TUNING =
    {
		...
		SHADOWWAXWELL_PROTECTOR_DAMAGE = 20, --tune for level 2 as standard
		SHADOWWAXWELL_PROTECTOR_DAMAGE_BONUS_PER_LEVEL = 10,
		...
		SHADOWWAXWELL_PROTECTOR_ACTIVE_LEADER_RANGE = 8,
