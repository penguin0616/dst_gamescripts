...
--[[
        ...
        ALTERGUARDIAN_PHASE1_HEALTH = 12000,
        ...
        ALTERGUARDIAN_PHASE1_ROLLCOOLDOWN = 7,
        ALTERGUARDIAN_PHASE1_MINROLLCOUNT = 4,
        ALTERGUARDIAN_PHASE1_SUMMONCOOLDOWN = 20,
        ALTERGUARDIAN_PHASE1_TARGET_DIST = 20,
        ALTERGUARDIAN_PHASE1_SHIELDTRIGGER = 1500,
        ...
        ALTERGUARDIAN_PHASE2_ATTACK_PERIOD = 4.75,
        ALTERGUARDIAN_PHASE2_CHOP_RANGE = 4.5,
        ALTERGUARDIAN_PHASE2_SPIN_RANGE = 18,
        ALTERGUARDIAN_PHASE2_SPIN_SPEED = 7.5,
        ...
        ALTERGUARDIAN_PHASE2_SUMMONCOOLDOWN = 20,
        ALTERGUARDIAN_PHASE2_TARGET_DIST = 30,

        ALTERGUARDIAN_PHASE3_WALK_SPEED = 6,
        ...
        ALTERGUARDIAN_PHASE3_TRAP_MINRANGE = 5.0,
        ALTERGUARDIAN_PHASE3_TRAP_MAXRANGE = 9.5,
        ALTERGUARDIAN_PHASE3_TRAP_AOERANGE = 2.5,
        ...
        ALTERGUARDIAN_PHASE3_SUMMONRSQ = 289, --17 ^2
        ...
        MOON_ALTAR_LINK_ALTAR_MIN_RADIUS_SQ = 6*6,
        MOON_ALTAR_LINK_BLOCK_TAGS = { "antlion_sinkhole_blocker" },
    }
