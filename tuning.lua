...
function Tune(overrides)
    ...
    TUNING =
    {
        ...
        SHADOWWAXWELL_PROTECTOR_DURATION = 60,
        SHADOWWAXWELL_PROTECTOR_SPEED = 6,
        SHADOWWAXWELL_PROTECTOR_DAMAGE = 40,
        SHADOWWAXWELL_PROTECTOR_LIFE = 75,
        SHADOWWAXWELL_PROTECTOR_ATTACK_PERIOD = 2,
        SHADOWWAXWELL_PROTECTOR_HEALTH_REGEN = 15,
        SHADOWWAXWELL_PROTECTOR_HEALTH_REGEN_PERIOD = 2,
        SHADOWWAXWELL_PROTECTOR_KITE_DIST = 6,
        SHADOWWAXWELL_PROTECTOR_DEFEND_RADIUS = 12,

        SHADOWWAXWELL_WORKER_DURATION = 60,
        SHADOWWAXWELL_WORKER_WORK_RADIUS = 12,

		SHADOW_TRAP_PANIC_TIME = 10,
		SHADOW_TRAP_NIGHTMARE_TIME = total_day_time * .5,
