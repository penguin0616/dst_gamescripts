...
--[[
        ...
        ALTERGUARDIAN_PHASE2_ATTACK_PERIOD = 4.25,
        ...
        ALTERGUARDIAN_PHASE2_SPIKECOOLDOWN = 9.0,
        ...
        ALTERGUARDIAN_PHASE3_TRAP_CD = 17,
        ALTERGUARDIAN_PHASE3_TRAP_MINRANGE = 3.5,
        ALTERGUARDIAN_PHASE3_TRAP_MAXRANGE = 6.0,
