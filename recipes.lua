...
Recipe2("turf_beard_rug",					{Ingredient("beardhair", 4), Ingredient("cutgrass", 4)},												TECH.SCIENCE_TWO,			{numtogive=4})
...
--
Recipe2("transmute_bluegem",            {Ingredient("redgem", 3)}, 	TECH.NONE, 				{product="bluegem", image="bluegem.tex", builder_tag="gem_alchemistI", description="transmute_bluegem"})
Recipe2("transmute_purplegem",          {Ingredient("bluegem", 3)}, TECH.NONE, 				{product="purplegem", image="purplegem.tex", builder_tag="gem_alchemistI", description="transmute_purplegem"})
...
Recipe2("transmute_beardhair",          {Ingredient("beefalowool", 3)}, 	TECH.NONE, 		{product="beardhair", image="beardhair.tex",     builder_tag="ick_alchemistII", description="transmute_beardhair"})
...
Recipe2("transmute_nightmarefuel",      {Ingredient("horrorfuel", 3)}, 	TECH.NONE, 		{product="nightmarefuel", image="nightmarefuel.tex",     builder_tag="skill_wilson_allegiance_shadow", description="transmute_nightmarefuel", numtogive=2})
