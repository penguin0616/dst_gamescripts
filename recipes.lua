...
Recipe2("wateringcan",						{Ingredient("boards", 2), Ingredient("rope", 1)},												TECH.SCIENCE_TWO)
...
Recipe2("birdtrap",							{Ingredient("twigs", 3),Ingredient("silk", 6)},													TECH.NONE)
...
Recipe2("meatrack",							{Ingredient("twigs", 3),Ingredient("charcoal", 2), Ingredient("rope", 3)},						TECH.SCIENCE_TWO)
